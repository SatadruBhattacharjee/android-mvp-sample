package com.tribe.sample.data.models;
...
public class MovieDetails implements Parcelable {
    ...
    public MovieDetails setRecommendations(MovieResponse recommendations) {
    ...
    protected MovieDetails(Parcel in) {
        ...
        this.recommendations = in.readParcelable(MovieResponse.class.getClassLoader());
